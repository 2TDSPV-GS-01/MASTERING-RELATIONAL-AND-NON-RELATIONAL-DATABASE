...
CREATE TABLE T_FV_CONTATO 
    ( 
     ID_CONTATO    INTEGER  DEFAULT SEQ_ID_CONTATO.NEXTVAL , 
...
CREATE TABLE T_FV_ENDERECO 
    ( 
     ID_ENDERECO INTEGER DEFAULT SEQ_ID_ENDERECO.NEXTVAL , 
...
CREATE TABLE T_FV_ESTACAO_TRATAMENTO 
    ( 
     ID_ESTACAO_TRATAMENTO INTEGER  DEFAULT SEQ_ID_ESTACAO.NEXTVAL , 
...
CREATE TABLE T_FV_MATERIAL 
    ( 
     ID_MATERIAL      INTEGER  DEFAULT SEQ_ID_MATERIAL.NEXTVAL , 
     NM_MATERIAL      VARCHAR2 (100)  NOT NULL , 
...
CREATE TABLE T_FV_SENSOR 
    ( 
     ID_SENSOR             INTEGER  DEFAULT SEQ_ID_SENSOR.NEXTVAL, 
